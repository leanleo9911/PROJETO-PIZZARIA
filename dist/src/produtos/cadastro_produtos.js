...
function cadastrarProduto() {
    ...
    let tipo;
    while (true) {
        tipo = readline_sync_1.default.question('Digite o Tipo (Pizza Tradicional, Pizza Especial, Bebida, Porções, Sobremesa, Outro): ');
        if (validarTipo(tipo))
            break;
    ...
    let sabor;
    while (true) {
        sabor = readline_sync_1.default.question('Digite o Sabor/Nome e Tamanho (P/M/G ou único): ');
    ...
    let preco;
    while (true) {
        preco = readline_sync_1.default.question('Digite o Preço: R$');
